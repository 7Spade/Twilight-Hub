...
import { useUploadFile, useDeleteFile, useDownloadFile, usePreviewFile, useFormatFileSize, useFileTypeIcon, useIsFileTypeSupported } from '@/hooks/use-file-operations';
...
export function FileUpload({
  ...
  }, [contractId, userId, documents, maxFiles, maxSize, uploadFile, onDocumentsChange]);
          ...
          <CardContent>
            <div className="space-y-2">
              {documents.map((document) => {
                const iconName = useFileTypeIcon(document.name);
