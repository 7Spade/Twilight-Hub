...
const defaultRoles: Role[] = [
  {
    id: '1',
    name: 'ÁµÑÁ?ÁÆ°Á???,
    description: 'Ë≤†Ë≤¨ÁµÑÁ??¥È?ÁÆ°Á??åÊ±∫Á≠?,
    isDefault: true,
    memberCount: 2,
  ...
  },
  {
    id: '2',
    name: 'BIM Á∂ìÁ?',
    description: 'Ë≤†Ë≤¨ BIM Â∞àÊ?ÁÆ°Á??åÂ?Ë™?,
    isDefault: true,
    memberCount: 3,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">ÁµÑÁ?ËßíËâ≤</h2>
          <p className="text-muted-foreground">ÁÆ°Á?ÁµÑÁ?‰∏≠Á?ËßíËâ≤?åÊ??êË®≠ÂÆ?/p>
        </div>
        {canManage && (
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm font-medium">
                Ê≠?ú®È°ØÁ§∫ {filteredRoles.length} ??(??{roles.length} ??
              </CardTitle>
            </CardHeader>
            ...
            <Card>
                  ...
                  <div>
                    <CardTitle className="flex items-center gap-2">
                      ...
                      {selectedRole.isDefault && (
                        <Badge variant="secondary">?êË®≠</Badge>
                      )}
                    </CardTitle>
              ...
              <CardContent className="space-y-6">
                ...
                <Tabs defaultValue="access">
                  <TabsList>
                    <TabsTrigger value="access">Â≠òÂ?</TabsTrigger>
                    <TabsTrigger value="members">?êÂì°</TabsTrigger>
                  </TabsList>

                  <TabsContent value="access" className="space-y-6">
                    {/* Default Access Level */}
                    <div>
                      <h4 className="text-sm font-medium mb-3">?êË®≠Â≠òÂ?Â±§Á?</h4>
                      <Select
                  ...
                  <TabsContent value="members">
                    <div className="space-y-4">
                      <p className="text-sm text-muted-foreground">
                        Ê≠§Ë??≤ÁõÆ?çÊ? {selectedRole.memberCount} ‰ΩçÊ???
                      </p>
            ...
            <Card>
              <CardContent className="flex items-center justify-center py-12">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-medium mb-2">?∏Ê?ËßíËâ≤</h3>
                  <p className="text-muted-foreground">
                    ÂæûÂ∑¶?¥Â?Ë°®ÈÅ∏?á‰??ãË??≤‰??•Á?Ë©≥Á¥∞Ë≥áË?
                  </p>
                </div>
              </CardContent>
            </Card>
