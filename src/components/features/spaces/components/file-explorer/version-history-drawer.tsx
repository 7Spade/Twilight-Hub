    ...
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent side="right" className="w-[400px] sm:w-[540px]">
        <SheetHeader className="flex flex-row items-center justify-between">
          <SheetTitle className="text-lg font-semibold">?àÊú¨Ê≠∑Âè≤Á¥Ä??/SheetTitle>
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8"
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>?àÊú¨</TableHead>
                    <TableHead>?çÁ®±</TableHead>
                    <TableHead>?áÊ?</TableHead>
                    <TableHead>Ê®ôË?</TableHead>
                    <TableHead className="w-12"></TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center gap-2 text-xs text-muted-foreground">
                            ...
                            <span>Â∑≤Áî±??{formatDate(version.updatedAt)}</span>
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
