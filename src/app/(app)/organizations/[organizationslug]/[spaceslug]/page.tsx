...
export default function OrgSpaceDetailsPage({
  ...
  useEffect(() => {
    const fetchSpaceAndOrg = async () => {
        ...
        const spaceQuery = query(spacesRef, where('slug', '==', params.spaceslug), where('ownerId', '==', currentOrg.id), limit(1));
  ...
  const isLoading = loading || profileLoading || installedModulesLoading || availableModulesLoading;
  ...
  if (!space || !org) {
    return <div>Space or Organization not found.</div>;
  }
        ...
        <TabsContent value="add" className="mt-6">
         ...
         <TabsContent value="settings" className="mt-6">
            <Card>
                ...
                <CardFooter>
                    <Link href={`/organizations/${params.organizationslug}/${params.spaceslug}/settings`}>
