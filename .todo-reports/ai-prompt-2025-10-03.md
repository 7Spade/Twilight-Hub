...
```
### 5. PERF: src/app/(app)/organizations/[organizationslug]/inventory/page.tsx:122 - 優化 React hooks 依賴項
...
```
### 6. PERF: src/app/(app)/organizations/[organizationslug]/inventory/[itemId]/page.tsx:95 - 優化 React hooks 依賴項
...
```
### 7. PERF: src/app/(app)/spaces/page.tsx:42 - 優化 React hooks 依賴項
...
```
### 8. PERF: src/components/features/spaces/hooks/use-file-actions.ts:105 - 優化 React hooks 依賴項
...
```typescript
  ...
  const downloadFile = useCallback(async (
    fileName: string, 
```
### 9. PERF: src/components/features/spaces/hooks/use-file-actions.ts:144 - 優化 React hooks 依賴項
...
```typescript
  ...
  const deleteFile = useCallback(async (
    fileName: string, 
```
### 10. PERF: src/components/features/spaces/hooks/use-file-actions.ts:178 - 優化 React hooks 依賴項
...
```typescript
  ...
  const listFiles = useCallback(async (
    spaceId: string,
```
### 11. PERF: src/components/features/spaces/hooks/use-file-actions.ts:208 - 優化 React hooks 依賴項
...
```typescript
  ...
  return {
    ...
    downloadFile,
```
### 12. REFACTOR: src/components/features/spaces/components/ - 減少過度抽象的組件層級
...
// @deadline 2025-01-20
```
### 13. REFACTOR: src/components/adjust-stock-dialog.tsx:133 - 修復非空斷言警告
...
```
### 14. REFACTOR: src/components/auth/auth-provider.tsx:195 - 修復 TypeScript any 類型使用
...
```
### 15. REFACTOR: src/components/features/spaces/components/file-explorer/file-explorer.tsx:341 - 修復 TypeScript any 類型使用
...
```
### 16. REFACTOR: src/components/features/spaces/components/file-explorer/file-explorer.tsx:346 - 修復 TypeScript any 類型使用
...
```typescript
  ...
  return (
```
### 17. REFACTOR: src/components/features/spaces/components/file-explorer/services/file-preview-service.ts:52 - 修復 TypeScript any 類型使用
...
```
### 18. REFACTOR: src/components/features/spaces/components/file-explorer/services/file-preview-service.ts:223 - 修復 TypeScript any 類型使用
...
```
### 19. REFACTOR: src/components/features/spaces/components/file-explorer/services/file-preview-service.ts:28 - 修復 TypeScript any 類型使用
...
```
### 20. REFACTOR: src/components/features/spaces/components/file-explorer/services/file-preview-service.ts:50 - 修復 TypeScript any 類型使用
...
```
### 21. REFACTOR: src/components/features/spaces/components/ - 合併重複的組件邏輯
...
// @deadline 2025-01-30
```
### 22. PERF: next.config.ts - 實現 Next.js 15 性能優化配置
...
```typescript
  ...
  // @deadline 2025-02-01
```
### 23. REFACTOR: src/components/features/spaces/hooks/ - 簡化 hooks 邏輯
...
```
# 處理第一個緊急項目
請根據 src\components\features\spaces\components\participants\participant-list.tsx 第 2 行的 TODO，完成修復
