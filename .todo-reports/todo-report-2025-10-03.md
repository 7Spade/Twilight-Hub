...
---
### 16. [CLEANUP] unused imports/vars (L28, L41, L70, L88, L89, L134) [低認知]
...
---
### 19. [REFACTOR] src/components/auth/role-manager.tsx:28 - 清理未使用的導入
...
---
### 20. [REFACTOR] src/components/auth/role-manager.tsx:34 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 21. [REFACTOR] src/components/auth/role-manager.tsx:57 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 22. [REFACTOR] src/components/auth/role-manager.tsx:61 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 23. [REFACTOR] src/components/auth/role-manager.tsx:62 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 24. [FEAT] src/components/features/organizations/components/roles/create-role-dialog.tsx - 實現角色創建 API 調用
**位置:** `src\components\features\organizations\components\roles\create-role-dialog.tsx:70`
---
### 25. [FEAT] src/components/features/organizations/components/roles/role-list.tsx - 實現權限更新邏輯
**位置:** `src\components\features\organizations\components\roles\role-list.tsx:169`
---
### 26. [FEAT] src/components/features/organizations/components/roles/role-list.tsx - 實現訪問級別更新邏輯
**位置:** `src\components\features\organizations\components\roles\role-list.tsx:175`
---
### 27. [REFACTOR] src/components/features/spaces/components/acceptance/acceptance-item.tsx:5 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 28. [FIX] src/components/features/spaces/components/acceptance/initiate-acceptance-flow.tsx - 修正 unknown/any 類型
...
---
### 29. [FEAT] src/components/features/spaces/components/acceptance/initiate-acceptance-flow.tsx - 實作創建驗收 API 呼叫
**位置:** `src\components\features\spaces\components\acceptance\initiate-acceptance-flow.tsx:57`
---
### 30. [REFACTOR] src/components/features/spaces/components/contracts/contract-details.tsx:3 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 31. [REFACTOR] src/components/features/spaces/components/contracts/contract-details.tsx:10 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 32. [FEAT] src/components/features/spaces/components/contracts/contract-details.tsx - 實現合約下載邏輯
**位置:** `src\components\features\spaces\components\contracts\contract-details.tsx:110`
---
### 33. [FIX] src/components/features/spaces/components/contracts/contract-list.tsx - 修復 JSX 語法錯誤（第317行未閉合標籤或無效字元）
**位置:** `src\components\features\spaces\components\contracts\contract-list.tsx:3`
---
### 34. [REFACTOR] src/components/features/spaces/components/contracts/contract-list.tsx:10 - 清理未使用的導入
...
---
### 35. [REFACTOR] src/components/features/spaces/components/contracts/contract-list.tsx - 奧卡姆剃刀精簡列表
...
> 3) 詳情 `ContractDetails` 採 lazy import（動態載入），減少首屏負擔。
---
### 36. [FIX] src/components/features/spaces/components/contracts/create-contract-dialog.tsx - 修正 unknown/any 類型
...
---
### 37. [FIX] src/components/features/spaces/components/file-explorer/context-menu.tsx - 修復字符串字面量錯誤（第126行未終止）
**位置:** `src\components\features\spaces\components\file-explorer\context-menu.tsx:7`
---
### 38. [FIX] src/components/features/spaces/components/file-explorer/deleted-items.tsx - 修復字符串字面量錯誤（第50行未終止）
**位置:** `src\components\features\spaces\components\file-explorer\deleted-items.tsx:8`
---
### 39. [FIX] src/components/features/spaces/components/file-explorer/empty-folder-state.tsx - 修復字符串字面量錯誤（第31行未終止）
**位置:** `src\components\features\spaces\components\file-explorer\empty-folder-state.tsx:8`
---
### 40. [REFACTOR] src/components/features/spaces/components/file-explorer/file-table.tsx:29 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 41. [REFACTOR] src/components/features/spaces/components/file-explorer/filter-panel.tsx:27 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 42. [REFACTOR] src/components/features/spaces/components/file-explorer/filter-panel.tsx:29 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 43. [REFACTOR] src/components/features/spaces/components/file-explorer/filter-panel.tsx:34 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 44. [REFACTOR] src/components/features/spaces/components/file-explorer/folder-tree.tsx:12 - Clean up unused imports
...
---
### 45. [REFACTOR] src/components/features/spaces/components/file-explorer/toolbar.tsx:13 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 46. [REFACTOR] src/components/features/spaces/components/file-explorer/upload-dialog.tsx:12 - 清理未使用的導入
...
> 建議：移除未使用的導入或添加下劃線前綴表示有意未使用
---
### 47. [FIX] src/components/features/spaces/components/issues/create-issue-form.tsx - 修正 unknown/any 類型
**位置:** `src\components\features\spaces\components\issues\create-issue-form.tsx:29`
**詳細說明:**
> 說明：以具名型別替代 unknown，為 issue 建立明確型別介面
---
### 48. [FEAT] src/components/features/spaces/components/issues/create-issue-form.tsx - 實作創建問題 API 呼叫
**位置:** `src\components\features\spaces\components\issues\create-issue-form.tsx:52`
---
### 49. [FEAT] src/components/features/spaces/components/overview/hooks/use-dashboard-data.ts - 替換為實際的 API 調用
**位置:** `src\components\features\spaces\components\overview\hooks\use-dashboard-data.ts:41`
**負責人:** @dev
**詳細說明:**
> 這裡使用模擬數據
---
### 50. [FEAT] src/components/features/spaces/components/overview/hooks/use-dashboard-data.ts - 替換為實際的 API 調用
**位置:** `src\components\features\spaces\components\overview\hooks\use-dashboard-data.ts:60`
**負責人:** @dev
**詳細說明:**
> 這裡使用模擬數據
---
### 51. [FIX] src/components/features/spaces/components/overview/types.ts - 修正 unknown/any 類型（定義 metadata 結構）
...
---
### 57. [FEAT] src/components/features/spaces/components/report/report-viewer.tsx - 實現實際下載邏輯
**位置:** `src\components\features\spaces\components\report\report-viewer.tsx:80`
---
### 58. [REFACTOR] src/components/features/spaces/hooks/use-file-actions.ts - 奧卡姆剃刀精簡檔案動作 Hook
...
---
### 59. [REFACTOR] src/components/features/spaces/hooks/use-star-actions.ts - 清理未使用的導入（Space 未使用）
**位置:** `src\components\features\spaces\hooks\use-star-actions.ts:14`
---
### 60. [REFACTOR] src/components/github-heat-map.tsx:39 - 清理未使用的變數
...
---
### 61. [REFACTOR] src/components/ui/chart.tsx - 奧卡姆剃刀精簡圖表層
...
---
### 62. [REFACTOR] src/firebase/firestore/use-collection.tsx - 控制快取與依賴穩定，降低重新訂閱
...
---
### 63. [FIX] src/hooks/use-app-state.ts - 修正 unknown/any 類型
**位置:** `src\hooks\use-app-state.ts:12`
**詳細說明:**
> 說明：以具名型別替代 unknown，為 dialog data 建立明確型別
---
### 64. [FIX] src/hooks/use-app-state.ts - 修正 unknown/any 類型
**位置:** `src\hooks\use-app-state.ts:28`
**詳細說明:**
> 說明：替換為具名型別或泛型參數，避免使用 unknown
---
### 65. [FIX] src/hooks/use-app-state.ts - 修正 unknown/any 類型
**位置:** `src\hooks\use-app-state.ts:74`
**詳細說明:**
> 說明：為 data 提供具名型別或受限泛型，避免使用 unknown
---
### 66. [REFACTOR] src/hooks/use-permissions.ts - 奧卡姆剃刀精簡權限 Hook
...
---
### 67. [REFACTOR] src/lib/role-management.ts - 合併查詢與快取，僅回傳最小資料
...
---
### 68. [REFACTOR] src/lib/role-management.ts - 奧卡姆剃刀精簡服務層
...
---
### 69. [FIX] src/lib/types-unified.ts - 修正 unknown/any 類型
**位置:** `src\lib\types-unified.ts:245`
**詳細說明:**
> 說明：以具名型別替代 unknown，或引入泛型以約束資料型別
---
## 🟢 P3 (2 個)
### 1. [REFACTOR] src/components/features/spaces/components/quality/quality-dashboard.tsx - 清理未使用的參數（spaceId 未使用）
**位置:** `src\components\features\spaces\components\quality\quality-dashboard.tsx:28`
---
### 2. [REFACTOR] src/components/ui/menubar.tsx - 奧卡姆剃刀精簡 API 表面
